...
static void test_syn_recv_insert_delete(int family, int sotype,
						int mapfd)
{
...
static void
test_skb_redir_to_connected(struct test_sockmap_listen *skel,
...
static void
test_msg_redir_to_connected(struct test_sockmap_listen *skel,
				    struct bpf_map *inner_map, int family,
				    int sotype)
{
...
static void
test_skb_redir_to_listening(struct test_sockmap_listen *skel,
				    struct bpf_map *inner_map, int family,
				    int sotype)
{
	int verdict = bpf_program__fd(skel->progs.prog_skb_verdict);
...
static void
test_msg_redir_to_listening(struct test_sockmap_listen *skel,
				    struct bpf_map *inner_map, int family,
				    int sotype)
{
	int verdict = bpf_program__fd(skel->progs.prog_msg_verdict);
...
static void test_reuseport_mixed_groups(int family, int sotype,
						int sock_map, int verd_map,
						int reuseport_prog)
{
	struct sockaddr_storage addr;
