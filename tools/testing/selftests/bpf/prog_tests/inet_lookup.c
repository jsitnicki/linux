...
static void query_lookup_prog(struct inet_lookup_progs *skel)
{
...
static void test_run_lookup_prog(struct inet_lookup_progs *skel)
{
...
static void test_drop_on_lookup(struct inet_lookup_progs *skel)
{
	const struct test tests[] = {
		{
...
static void test_drop_on_reuseport(struct inet_lookup_progs *skel)
{
	const struct test tests[] = {
		{
